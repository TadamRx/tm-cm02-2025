...
quantile(chp$age)
# Checking the distribution of the variable (using histogram)
hist(chp$age,breaks = 100,xlab="age (year)", main="Histogram of Age")
# Checking for outliers (using box plot)
boxplot(chp$age,ylab="Age (year)", main="Boxplot of Age",col = 'grey')
...
# Checking the distribution of the variable (using histogram)
hist(chp$bmi,breaks = 100,xlab="bmi (year)", main="Histogram of bmi")
# Checking for outliers (using box plot)
boxplot(chp$age,ylab="bmi (year)", main="Boxplot of bmi",col = 'grey')
